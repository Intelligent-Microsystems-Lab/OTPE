...
torch.manual_seed(0)
np.random.seed(0)
lr_ind,seed_ind = np.unravel_index(int(sys.argv[1])-1,(10,4))
...
seq_len = 50
slope = 25
lr = ['001','00085','0007','00055','0004','00025','0001','000085','00007','000055'][lr_ind]
manifold_seed_val = 0
init_seed_val = seed_ind
...
optimizer = optax.adamax(dtype([0.001,0.00085,0.0007,0.00055,0.0004,0.00025,0.0001,0.000085,0.00007,0.000055][lr_ind]))
